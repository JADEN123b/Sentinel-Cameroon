    ...
    if (empty($errors)) {
        ...
        if ($stmt->fetch()) {
            ...
            if ($stmt) {
                ...
                if (!$mail_sent) {
                    // Email failed but account was created — log it and let user know
                    error_log("[Register] Verification email failed for: {$email}");
                }
...
<head>
    ...
    <title>Register | Sentinel Cameroon</title>
                ...
                <?php if ($just_registered): ?>
                    <div class="text-center">
                        <span class="material-symbols-outlined"
                            style="font-size:72px;color:#1a73e8;font-variation-settings:'FILL' 1;">mark_email_unread</span>
                        ...
                        <p class="text-sm text-gray-500 mb-6">Didn't get it? Check your spam folder, or <a
                                href="register.php" class="text-primary hover:underline">try registering again</a>.</p>
                        <a href="login.php" class="btn btn-primary">Go to Sign In</a>
                    </div>
                <?php else: ?>

                    <div class="text-center mb-8">
                        <h1 class="text-3xl font-bold text-primary mb-2">Join Sentinel Cameroon</h1>
                        <p class="text-gray-600">Help keep our community safe</p>
                    </div>
