...
class AutoEmailSender {
    ...
    public function __construct() {
        // Auto-email sender configuration
        $this->smtp_username = 'chooazah@gmail.com'; // Your sender email
        $this->smtp_password = 'gvfgpbnbafxk   hjnh'; // Your App Password
        $this->from_email = 'chooazah@gmail.com'; // Your sender email
        $this->from_name = 'Sentinel Cameroon'; // Your sender name
        $this->reply_to = 'chooazah@gmail.com'; // Your reply-to email
    }
    ...
    /**
     * Send incident notification automatically
     */
    ...
    /**
     * Send system notification automatically
     */
    ...
    private function sendEmail($to_email, $subject, $message) {
        try {
            ...
            $headers .= "X-Mailer: Sentinel Cameroon Auto-Sender/" . phpversion();
            
            // Use PHP's mail() function with SMTP configuration
            if (mail($to_email, $subject, $message, $headers)) {
                error_log("Auto-email sent successfully to: $to_email");
                return true;
            } else {
                error_log("Auto-email failed to: $to_email");
                return false;
            }
    ...
    public function isAvailable() {
        return function_exists('mail') && !empty($this->smtp_password) && $this->smtp_password !== 'your-app-password';
    }
    ...
    private function getVerificationTemplate($name, $verification_link) {
        ...
        <head>
            <style>
                ...
                .auto-sender { background: #e3f2fd; padding: 10px; border-radius: 5px; margin: 10px 0; }
            </style>
        </head>
        <body>
            <div class='container'>
                ...
                <div class='content'>
                    ...
                    <div class='auto-sender'>
                        <p><strong>📧 Automated Email:</strong> This email was sent automatically by our system.</p>
                    </div>
                    ...
                    <div class='footer'>
                        ...
                        <p>Sent automatically by Sentinel Cameroon Email System</p>
